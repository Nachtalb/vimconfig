...
autocmd FileType fish,sh,rst,markdown,md,html,xml,javascript,css,scss,sass,less,scss.css,yaml,yml,sshconfig setlocal shiftwidth=2 tabstop=2 softtabstop=2
autocmd FileType fish,sh,rst,markdown,md,html,xml,javascript,css,scss,sass,less,scss.css,yaml,yml setlocal iskeyword+=-
